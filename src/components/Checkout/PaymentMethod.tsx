        ...
        <div className='flex flex-col gap-3'>
          <label htmlFor='bank' className='flex cursor-pointer select-none items-center gap-4'>
            <div className='relative'>
              ...
              <div
                className={`flex h-4 w-4 items-center justify-center rounded-full ${
                  payment === 'bank' ? 'border-4 border-blue' : 'border border-gray-4'
                }`}
              ></div>
            </div>
            ...
            <div
              className={`rounded-md border-[0.5px] py-3.5 px-5 ease-out duration-200 hover:bg-gray-2 hover:border-transparent hover:shadow-none ${
                payment === 'bank' ? 'border-transparent bg-gray-2' : ' border-gray-4 shadow-1'
              }`}
            >
          ...
          <label htmlFor='cash' className='flex cursor-pointer select-none items-center gap-4'>
            <div className='relative'>
              ...
              <div
                className={`flex h-4 w-4 items-center justify-center rounded-full ${
                  payment === 'cash' ? 'border-4 border-blue' : 'border border-gray-4'
                }`}
              ></div>
            </div>
            ...
            <div
              className={`rounded-md border-[0.5px] py-3.5 px-5 ease-out duration-200 hover:bg-gray-2 hover:border-transparent hover:shadow-none min-w-[240px] ${
                payment === 'cash' ? 'border-transparent bg-gray-2' : ' border-gray-4 shadow-1'
              }`}
            >
              <div className='flex items-center'>
                <div className='pr-2.5'>
          ...
          <label htmlFor='paypal' className='flex cursor-pointer select-none items-center gap-4'>
            <div className='relative'>
              ...
              <div
                className={`flex h-4 w-4 items-center justify-center rounded-full ${
                  payment === 'paypal' ? 'border-4 border-blue' : 'border border-gray-4'
                }`}
              ></div>
            </div>
            <div
              className={`rounded-md border-[0.5px] py-3.5 px-5 ease-out duration-200 hover:bg-gray-2 hover:border-transparent hover:shadow-none min-w-[240px] ${
                payment === 'paypal' ? 'border-transparent bg-gray-2' : ' border-gray-4 shadow-1'
              }`}
            >
              <div className='flex items-center'>
                <div className='pr-2.5'>
