          ...
          <div className='flex flex-col lg:flex-row gap-7.5 xl:gap-12.5'>
            ...
            <div className='lg:max-w-[750px] w-full'>
              ...
              <div>
                ...
                <p className='mb-6'>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer sit amet eros ac ipsum egestas
                  dapibus. Vivamus gravida, ex non placerat tincidunt, lorem felis facilisis tellus, vitae bibendum
                  purus felis eget tellus. In non rutrum ipsum. Morbi ut dui ante.
                </p>

                <p className='mb-6'>
                  Nunc faucibus libero sem, quis placerat nisl pellentesque eget. Morbi porta velit ut leo sollicitudin,
                  a faucibus purus faucibus. Maecenas mollis dui nec metus euismod, sed aliquam risus luctus.
                </p>

                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
                  dolore magna aliqua. Quis enim lobortis scelerisque fermentum. Neque sodales ut etiam sit amet. Ligula
                  ullamcorper malesuada proin libero nunc consequat interdum varius. Quam pellentesque nec nam aliquam
                ...
                <div className='rounded-xl bg-white pt-7.5 pb-6 px-4 sm:px-7.5 my-7.5'>
                  <p className='italic text-dark text-center'>
                    ...
                    et dolore magna aliqua quis fermentum,,
                  </p>
