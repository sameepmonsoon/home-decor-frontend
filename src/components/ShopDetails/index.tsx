...
const ShopDetails = () => {
  ...
  const [material, setMaterial] = useState('Solid Sheesham Wood with Natural Finish');
  ...
  const colors = ['beige', 'brown', 'gray', 'white', 'black', 'oak', 'walnut'];
              ...
              <div className='lg:max-w-[570px] w-full'>
                <div className='lg:min-h-[512px] rounded-lg shadow-1 bg-gray-2 p-4 sm:p-7.5 relative flex items-center justify-center'>
                  <div>
                    ...
                    <Image src={product.imgs?.previews[previewImg]} alt='products-details' width={400} height={400} />
                  </div>
                </div>
              ...
              <div className='max-w-[539px] w-full'>
                ...
                <form onSubmit={e => e.preventDefault()}>
                  <div className='flex flex-col gap-4.5 border-y border-gray-3 mt-7.5 mb-9 py-9'>
                    ...
                    <div className='flex items-center gap-4'>
                      <div className='min-w-[65px]'>
                        <h4 className='font-medium text-dark'>Materials:</h4>
                      </div>

                      <div className='flex items-center gap-4 flex-wrap'>
                        {furnitureMaterials.map((item, key) => (
                          <label
                            key={key}
                            htmlFor={item.id}
                            className='flex cursor-pointer select-none items-center whitespace-nowrap'
                          >
                            <div className='relative'>
                              <input
                                type='checkbox'
                              ...
                              <div
                                className={`mr-2 flex h-4 w-4 items-center justify-center rounded border ${
                                  material === item.id ? 'border-blue bg-green' : 'border-gray-4'
                                } `}
                              >
                                <span className={material === item.id ? 'opacity-100' : 'opacity-0'}>
                                  <svg
                                    width='24'
                                    height='24'
                                    viewBox='0 0 24 24'
                                    ...
                                    xmlns='http://www.w3.org/2000/svg'
                                  >
                                    <rect x='4' y='4.00006' width='16' height='16' rx='4' fill='#00A65A' />
                                    <path
                                      fillRule='evenodd'
                                      clipRule='evenodd'
                    ...
                    <div className='flex items-center gap-4'>
                      ...
                      <div className='flex items-center gap-4'>
                        {types.map((item, key) => (
                          <label key={key} htmlFor={item.id} className='flex cursor-pointer select-none items-center'>
                            <div className='relative'>
                              <input
                                type='checkbox'
                                name='material'
                              ...
                              <div
                                className={`mr-2 flex h-4 w-4 items-center justify-center rounded border ${
                                  type === item.id ? 'border-blue bg-green' : 'border-gray-4'
                                } `}
                              >
                        ...
                        {furnitureSizes.map((item, key) => (
                          <label key={key} htmlFor={item.id} className='flex cursor-pointer select-none items-center'>
                            <div className='relative'>
                              ...
                              <div
                                className={`mr-2 flex h-4 w-4 items-center justify-center rounded border ${
                                  size === item.id ? 'border-blue bg-green' : 'border-gray-4'
                                } `}
                              >
                                <span className={size === item.id ? 'opacity-100' : 'opacity-0'}>
                                  <svg
                                    width='24'
                                    height='24'
                                    viewBox='0 0 24 24'
              ...
              {tabs.map((item, key) => (
                <button
                  ...
                  className={`font-medium lg:text-lg ease-out duration-200 hover:text-green relative before:h-0.5 before:bg-green before:absolute before:left-0 before:bottom-0 before:ease-out before:duration-200 hover:before:w-full ${
                    activeTab === item.id ? 'text-green before:w-full' : 'text-dark before:w-0'
                  }`}
                >
                  {item.title}
                </button>
              ...
              >
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  ...
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>FurniVerse Home</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  ...
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>Wooden Dining Table Set (4 Chairs + Table)</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  ...
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>Solid Sheesham Wood with Natural Finish</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  <div className='max-w-[450px] min-w-[140px] w-full'>
                    <p className='text-sm sm:text-base text-dark'>Dimensions</p>
                  </div>
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>
                      Table: 60L x 36W x 30H (inches), Chair: 18L x 18W x 36H (inches)
                    </p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  <div className='max-w-[450px] min-w-[140px] w-full'>
                    <p className='text-sm sm:text-base text-dark'>Seating Capacity</p>
                  </div>
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>4 Persons</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  ...
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>Approx. 45 kg</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  <div className='max-w-[450px] min-w-[140px] w-full'>
                    <p className='text-sm sm:text-base text-dark'>Color</p>
                  </div>
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>Walnut Brown</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  <div className='max-w-[450px] min-w-[140px] w-full'>
                    <p className='text-sm sm:text-base text-dark'>Surface Finish</p>
                  </div>
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>Matte Lacquered Finish</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  <div className='max-w-[450px] min-w-[140px] w-full'>
                    <p className='text-sm sm:text-base text-dark'>Assembly</p>
                  </div>
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>Easy Self-Assembly (Tools & Manual Included)</p>
                  </div>
                </div>
                ...
                <div className='rounded-md even:bg-gray-1 flex py-4 px-4 sm:px-5'>
                  <div className='max-w-[450px] min-w-[140px] w-full'>
                    <p className='text-sm sm:text-base text-dark'>Warranty</p>
                  </div>
                  <div className='w-full'>
                    <p className='text-sm sm:text-base text-dark'>1 Year Warranty Against Manufacturing Defects</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              >
                <div className='max-w-[570px] w-full'>
                  <h2 className='font-medium text-2xl text-dark mb-9'>03 Review for this product</h2>
                  ...
                  <div className='flex flex-col gap-6'>
                    ...
                    <div className='rounded-xl bg-white shadow-1 p-4 sm:p-6'>
                      ...
                      <p className='text-dark mt-6'>
                        “Lorem ipsum dolor sit amet, adipiscing elit. Donec malesuada justo vitaeaugue suscipit
                        beautiful vehicula’’
                      </p>
                    </div>
