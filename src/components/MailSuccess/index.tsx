        ...
        <div className='max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0'>
          <div className='bg-white rounded-xl shadow-1 px-4 py-10 sm:py-15 lg:py-20 xl:py-25'>
            <div className='text-center'>
              <h2 className='font-bold text-green text-4xl lg:text-[45px] lg:leading-[57px] mb-5'>Successful!</h2>
              ...
              <p className='max-w-[491px] w-full mx-auto mb-7.5'>
                Thank you so much for your message. We check e-mail frequently and will try our best to respond to your
                inquiry.
              </p>
