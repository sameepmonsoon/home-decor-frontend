      ...
      <div className='max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0'>
        <div className='relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15'>
          <div className='max-w-[422px] w-full'>
            <span className='block font-medium text-custom-1 text-green mb-2.5'>Don’t Miss!!</span>

            <h2 className='font-bold text-dark text-xl lg:text-heading-4 xl:text-heading-3 mb-3'>
              Enhance Your Sitting Experience
            </h2>

            <p>White and Brown Floral Chair</p>
            ...
            <a
              href='#'
              className='inline-flex font-medium text-custom-sm text-white bg-green py-3 px-9.5 rounded-md ease-out duration-200 hover:bg-green-dark mt-7.5'
            >
              Check it Out!
            </a>
          </div>
          ...
          <Image
            ...
            alt='product'
            className='hidden lg:block absolute right-4 xl:right-33 bottom-4 xl:bottom-24 -z-1'
            width={311}
            height={376}
          />
        </div>
