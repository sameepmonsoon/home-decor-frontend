...
import { menuData, searchOptions } from './menuData';
        ...
        >
          ...
          <div className='xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10'>
            <Link className='flex-shrink-0' href='/'>
              <Image src='/images/logo/logo.png' alt='Logo' width={150} height={22} />
            </Link>
          ...
          <div className='flex w-full lg:w-auto items-center gap-7.5'>
            <div className='hidden xl:flex items-center gap-3.5'>
              ...
              <div>
                ...
                <p className='font-medium text-custom-sm text-dark'>(+977) 980-000-0000</p>
              </div>
            </div>
                  ...
                  {menuData.map((menuItem, i) => {
                    ...
                    return menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className={cn(
                          'group relative before:w-0 before:h-[3px] before:bg-green before:absolute before:left-0 before:top-0 before:rounded-b-[3px] before:ease-out before:duration-200 hover:before:w-full',
                      ...
                      >
                        <Link
                          href={menuItem.path}
                          className={cn(
                            'hover:text-green text-custom-sm font-medium text-dark flex xl:py-6',
                            stickyMenu && 'xl:py-4',
...
const UserAccount = () => {
  ...
  const isAuthneticated = session.status === 'authenticated';
