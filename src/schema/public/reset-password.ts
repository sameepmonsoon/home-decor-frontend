...
export const changePasswordProfileSchema = z.intersection(oldPasswordSchema, newPasswordSchema);

export type ChangePasswordProfileSchemaType = z.infer<typeof changePasswordProfileSchema>;
